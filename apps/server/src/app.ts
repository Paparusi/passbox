...
import { webhooks as webhooksRoute } from './routes/webhooks.js';
...
protectedApp.route('/vaults', environments);
protectedApp.route('/vaults', webhooksRoute);
protectedApp.route('/vaults', rotation);
