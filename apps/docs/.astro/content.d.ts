...
"getting-started/architecture.mdx": {
	id: "getting-started/architecture.mdx";
...
"github-action/usage.mdx": {
	id: "github-action/usage.mdx";
  slug: "github-action/usage";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"reference/encryption.mdx": {
	id: "reference/encryption.mdx";
  slug: "reference/encryption";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"reference/plans.mdx": {
	id: "reference/plans.mdx";
...
"sdk/environments.mdx": {
	id: "sdk/environments.mdx";
  slug: "sdk/environments";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"self-hosting/manual.mdx": {
	id: "self-hosting/manual.mdx";
  slug: "self-hosting/manual";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
